<template>
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800 self-start">
...
<div class="hover:text-white">
      ...
      <x-logo></x-logo>
        <span class="self-center font-semibold whitespace-nowrap text-sky-800 text-6xl font-fugaz-one hover:text-gray-200">Dreams</span>
    </a>
