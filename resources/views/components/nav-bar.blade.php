<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800 self-start">
...
<div class="hover:text-white">
      ...
      <x-logo></x-logo>
        <span class="self-center font-semibold whitespace-nowrap text-sky-800 text-6xl font-fugaz-one hover:text-white">Dreams</span>
    </a>
    ...
    <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
      <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
        ...
        <li>
          <a href="/MyAccount" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Mi cuenta</a>
        </li>
      </ul>
    </div>
    </div>
